...
public class RestaurantFactory {
    ...
    public Restaurant buildRestaurant(
        ...
        if (hasReservationConfiguration(reservations)) {
            return buildRestaurantWithReservationConfiguration(ownerId, name, capacity, hours, reservations);
        } else {
            return buildRestaurantWithoutReservationConfiguration(ownerId, name, capacity, hours);
        }
    }
